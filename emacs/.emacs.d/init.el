...
(custom-set-variables
 ...
 '(package-selected-packages
        (quote
         (smooth-scrolling fortune-cookie highlight-indent-guides try page-break-lines geeknote markdown-mode sr-speedbar ac-emmet emmet-mode ac-c-headers auto-complete irony helm avy swiper nlinum-relative multiple-cursors windresize ido-better-flex ido-vertical-mode smex recentf-ext rainbow-delimiters popup highlight-parentheses fsm atom-one-dark-theme)))
 '(show-paren-mode t)
 '(sublimity-mode t)
 '(tool-bar-mode nil)
